...
def test_data_validation(source_data, raw_layer_data, target_data):
    validator = DataValidator(config["source_file"], "", "")
    validator.validate_data(source_data, raw_layer_data)
    validator.validate_data(raw_layer_data, target_data)
